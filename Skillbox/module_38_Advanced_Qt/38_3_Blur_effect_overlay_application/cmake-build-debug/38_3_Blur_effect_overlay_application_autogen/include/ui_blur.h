...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        blurRadius = new QSlider(centralwidget);
        blurRadius->setObjectName(QString::fromUtf8("blurRadius"));
        blurRadius->setMaximum(10);
        blurRadius->setOrientation(Qt::Horizontal);

        verticalLayout->addWidget(blurRadius);
        ...
        QObject::connect(openFile, SIGNAL(clicked()), MainWindow, SLOT(openFile()));
        QObject::connect(blurRadius, SIGNAL(valueChanged(int)), MainWindow, SLOT(setBlurRadius()));
