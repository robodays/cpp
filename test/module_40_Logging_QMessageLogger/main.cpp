...
Q_LOGGING_CATEGORY(Action, "Action");
...
void  messageHandler(QtMsgType type, const QMessageLogContext &context, const QString &msg) {
    ...
    out << QDateTime::currentDateTime().toString("yyyy-MM-dd_hh:hh:ss - ");
...
//    qInstallMessageHandler(messageHandler);// отключаем вывод в консоль и пишем лог в файл
...
*/
    ...
    {
      qDebug(Action()) << "New value: "  << newValue;
