...
QT_INIT_METAOBJECT const QMetaObject BusinessLogic::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_BusinessLogic.data,
